...
class JigsawPuzzleCardBorderLightWidget extends StatefulWidget {
  ...
  const JigsawPuzzleCardBorderLightWidget({
    Key? key,
    required this.data,
    required this.color,
  }) : super(key: key);
  ...
  @override
  State<JigsawPuzzleCardBorderLightWidget> createState() =>
      _JigsawPuzzleCardBorderLightWidgetState();
}

class _JigsawPuzzleCardBorderLightWidgetState
    extends State<JigsawPuzzleCardBorderLightWidget> {
  @override
