...
import 'package:jigsaw/core/enums/jigsaw_status_enum.dart';
import 'package:jigsaw/presentation/jigsaw/widgets/jigsaw_puzzle.dart';
import 'package:jigsaw/presentation/jigsaw/widgets/jigsaw_puzzle_card_placeholder.dart';
...
class DraggableJigsawPuzzleCardWidget extends StatelessWidget {
  ...
  const DraggableJigsawPuzzleCardWidget({
    Key? key,
    required this.data,
...
class DragTargetJigsawPuzzleCardWidget extends StatefulWidget {
  ...
  @override
  State<DragTargetJigsawPuzzleCardWidget> createState() =>
      _DragTargetJigsawPuzzleCardWidgetState();
}

class _DragTargetJigsawPuzzleCardWidgetState
    extends State<DragTargetJigsawPuzzleCardWidget> {
  JigsawStatusEnum _jigsawPuzzleStatus = JigsawStatusEnum.normal;
  int? _willAcceptId;
  ...
  Widget build(BuildContext context) {
    ...
    if (_jigsawPuzzleStatus == JigsawStatusEnum.correct) {
      _jigsawPuzzleStatus = JigsawStatusEnum.normal;
    }
    return Stack(
      children: list,
    );
  ...
  Widget _buildDragTargetWidget() {
    _JigsawPuzzleCardWidget jigsawPuzzleCardWidget = _JigsawPuzzleCardWidget(
      ...
      top: -widget.data.top,
      active: _jigsawPuzzleStatus == JigsawStatusEnum.correct,
    ...
    return DragTarget(
      ...
      onAccept: (JigsawPuzzleData? value) {
        ...
        setState(() {
          ...
          if (correct) {
            _jigsawPuzzleStatus = JigsawStatusEnum.correct;
            widget.onCorrectCallback(value.id(), widget.data);
          } else {
            _jigsawPuzzleStatus = JigsawStatusEnum.error;
...
class _JigsawPuzzleCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      painter: _JigsawPuzzleCardPainter(
          srcImage, borderPath, top, left, active, needCover),
...
class _JigsawPuzzleCardPainter extends CustomPainter {
  ...
  void _drawBorder(Canvas canvas, Size size) {
    Paint paint = Paint()..color = const Color(0XFFF0F0F0);
